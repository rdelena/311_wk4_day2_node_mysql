...
const getAllUsers = (req, res) => {
  ...
  pool.query(
    "SELECT users.*, usersaddress.*, userscontact.* FROM users JOIN usersaddress ON users.id = usersaddress.user_id JOIN userscontact ON users.id = userscontact.user_id ORDER BY users.id",
    (err, rows) => {
